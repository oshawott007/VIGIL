...
# # Load chat data (unchanged from your original)
# def load_chat_data():
...
# # Initialize session state and chat data
...
#     caps = {}
#     video_placeholders.clear()  # Clear any existing placeholders
...
#                     logger.info(f"Initialized placeholder for {cam_name}")
#                 else:
...
#                 status_placeholder.error(f"Error initializing camera {cam_name}")
...
#                 except Exception as e:
#                     logger.error(f"Error processing {cam_name}: {e}")
#                     status_placeholder.error(f"Error processing {cam_name}")
#                     continue
...
#                     status_placeholder.error(f"Error displaying frame for {cam_name}")
...
#     finally:
#         # Cleanup - ensure resources are released even if error occurs
#         for cam_name, cap in caps.items():
#             try:
#                 cap.release()
#                 logger.info(f"Released camera: {cam_name}")
#             except Exception as e:
#                 logger.error(f"Error releasing camera {cam_name}: {e}")
